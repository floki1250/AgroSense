...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Immo',
            fields=[
                ('idimmo', models.CharField(max_length=255, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=255)),
                ('order_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.purchaseorderheader')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField()),
                ('end_date', models.DateField()),
                ('lineno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.productiondetail')),
                ('lot_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.productionheader')),
            ],
        ),
        migrations.AddField(
            model_name='productiondetail',
            name='lot_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.productionheader'),
        ),
        migrations.CreateModel(
            name='ItemPDetail',
            fields=[
