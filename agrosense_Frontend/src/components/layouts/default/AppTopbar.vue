...
<template>
  <div class="layout-topbar" style="padding: 0px">
    <button class="p-link layout-menu-button layout-topbar-button" @click="onMenuToggle" style="margin-right: 10px">
      <Icon name="tabler:menu-2" width="30" height="30"></Icon>
      <!-- <i class="pi pi-bars" /> -->
    </button>
    <NuxtLink to="/" class="layout-topbar-logo">
      <img alt="Logo" src="/images/agro.svg" />
      <span style="color: #45c295">AgroSense</span>
    </NuxtLink>
    ...
    <TransitionGroup name="fade" tag="ul"
      ...
      style="background-color: whitesmoke;border-radius: 2rem;margin-right: 0.5rem;" @mouseover="hover = true"
